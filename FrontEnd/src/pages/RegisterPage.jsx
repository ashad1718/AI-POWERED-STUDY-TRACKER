...
const RegisterPage = ({ handleLogin }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      handleLogin({ email, name: name || email.split('@')[0] });
      setLoading(false);
      navigate('/dashboard');
    }, 1200);
  };
        ...
        <GlassCard className="!p-8 shadow-2xl relative" hoverEffect={false}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-[10px] text-gray-500 leading-normal">
              By checking out, you agree to our Terms of Service and Privacy Policy. StudyAI will occasionally send you automated study alerts.
            </p>
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-400">
              ...
              <Link to="/login" className="text-[#00E5FF] hover:underline font-semibold">
                Sign In
              </Link>
            </p>
          </div>
